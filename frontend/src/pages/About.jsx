...
function About() {
  ...
  return (
    <div className="min-h-screen bg-[#060708] text-white font-sans selection:bg-brand-orange/30 selection:text-white relative overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 py-4 px-6 md:px-12 bg-black/20 backdrop-blur-md border-b border-white/5 flex items-center justify-between">
        <Link 
          to="/lobby" 
        ...
        <div className="flex items-center gap-2">
          <span className="p-1 bg-gradient-to-br from-brand-orange to-brand-blue rounded-md text-white">
            <Sparkles size={12} />
          </span>
      ...
      {/* Section 1: The Hero Landing (First Impression) */}
      <section className="relative h-screen flex flex-col justify-center items-center px-6 text-center select-none overflow-hidden">
        {/* Deep mesh gradient inside Hero */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(11,12,14,0.3),rgba(6,7,8,1))]" />
        ...
        <div className="z-10 max-w-4xl space-y-6 animate-fade-in">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-[1.1] text-white">
            Engineering <span className="bg-gradient-to-r from-brand-orange via-pink-500 to-brand-blue bg-clip-text text-transparent">scalable systems.</span>
            <br />
          ...
          <p className="text-base sm:text-xl text-text-muted max-w-xl mx-auto font-medium tracking-wide">
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2 opacity-50 hover:opacity-100 transition-opacity">
          <span className="text-[10px] uppercase font-bold tracking-widest text-text-muted">Scroll to Explore</span>
      ...
      <section className="py-24 md:py-36 max-w-5xl mx-auto px-6 relative">
        <ScrollReveal>
          <div className="space-y-6 md:space-y-8">
            ...
            <p className="text-lg sm:text-2xl text-text-light font-normal leading-relaxed max-w-4xl">
      ...
      {/* Section 2.5: The Project Description (Grow Together details) */}
      <section className="py-24 bg-black/30 border-y border-white/5 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <p className="text-text-muted text-sm sm:text-base leading-relaxed">
                  <strong>Grow Together</strong> is the platform you are currently exploring. It is a premium, real-time collaborative workspace engineered to synchronize tasks, goals, progress analytics, and candidate applications between developers in perfect synchrony.
                </p>
                <div className="flex gap-4">
                  <Link to="/lobby" className="flex items-center gap-1.5 text-xs font-bold text-[#0b0c0e] bg-white hover:bg-white/90 px-4 py-2.5 rounded-xl transition-all shadow-md">
                    Launch Workspace Lobby <ArrowUpRight size={14} />
                  </Link>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {/* Pillar 1 */}
                <div className="premium-card p-6 space-y-3 hover:border-brand-orange/30 transition-all duration-300">
                  ...
                  <h3 className="font-bold text-white text-sm">Real-Time WebSockets</h3>
                ...
                {/* Pillar 2 */}
                <div className="premium-card p-6 space-y-3 hover:border-brand-blue/30 transition-all duration-300">
                ...
                {/* Pillar 3 */}
                <div className="premium-card p-6 space-y-3 hover:border-brand-purple/30 transition-all duration-300">
                  ...
                  <h3 className="font-bold text-white text-sm">Activity Heatmap</h3>
                  <p className="text-text-muted text-xs leading-relaxed">
                ...
                {/* Pillar 4 */}
                <div className="premium-card p-6 space-y-3 hover:border-brand-yellow/30 transition-all duration-300">
                  ...
                  <h3 className="font-bold text-white text-sm">Premium Aesthetics</h3>
                  <p className="text-text-muted text-xs leading-relaxed">
                    Built using an elegant, responsive glassmorphic design language featuring custom animations and a dark-mode palette.
                  </p>
                </div>
      ...
      {/* Section 3: The Architecture (Experience & Scale) */}
        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-24 h-fit">
              <span className="text-xs font-bold uppercase tracking-widest text-brand-yellow px-3 py-1.5 rounded-full bg-brand-yellow/10 border border-brand-yellow/20">
                Experience & Scale
              </span>
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              {/* Card 1: MERN */}
              <div className="premium-card p-8 hover:translate-x-2 transition-transform duration-300 relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-extrabold text-white text-lg tracking-tight">MERN Full-Stack</h3>
                  </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['React.js', 'Node.js', 'Express.js', 'MongoDB', 'WebSockets'].map((tech) => (
                    <span key={tech} className="text-[10px] font-semibold text-text-light bg-white/5 border border-white/10 px-2 py-1 rounded-lg">
                      {tech}
                    </span>
                  ))}
                </div>
              ...
              <div className="premium-card p-8 hover:translate-x-2 transition-transform duration-300 relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-extrabold text-white text-lg tracking-tight">C++ Systems</h3>
                  </div>
              ...
              <div className="premium-card p-8 hover:translate-x-2 transition-transform duration-300 relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-extrabold text-white text-lg tracking-tight">Python & Data</h3>
                  </div>
                  <span className="text-[10px] uppercase font-bold text-brand-purple tracking-widest bg-brand-purple/10 px-2.5 py-1 rounded-md">AI Integration</span>
                </div>
                <p className="text-text-muted text-xs leading-relaxed mb-4">
      ...
      {/* Section 4: The Innovation (AI Integration) */}
      <section className="py-28 relative overflow-hidden bg-black/45 border-y border-white/5">
        ...
        {/* Radial Purple Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-brand-purple/10 rounded-full blur-[140px] pointer-events-none" />

        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <ScrollReveal>
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-purple/10 border border-brand-purple/20">
                <Cpu size={14} className="text-brand-purple animate-pulse" />
                <span className="text-[10px] font-bold tracking-wider text-brand-purple uppercase">Oracle Certified GenAI Professional</span>
              </div>
              ...
              <p className="text-lg sm:text-xl text-text-light font-light leading-relaxed">
                I don't just build traditional software; I build systems that think. As an Oracle Certified Generative AI Professional, I integrate machine learning and NLP directly into the user experience, transforming raw logic into intelligent behavior.
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                {/* Bullet 1 */}
                <div className="premium-card p-6 bg-black/40 backdrop-blur-md hover:border-brand-purple/35 transition-all">
                  <div className="flex gap-4">
                    <span className="flex-shrink-0 w-8 h-8 rounded-lg bg-brand-purple/10 flex items-center justify-center text-brand-purple text-xs font-bold">01</span>
                    <div className="space-y-1">
                      <h4 className="font-bold text-white text-sm">Centralized ERP & Study Guides</h4>
                      <p className="text-text-muted text-xs leading-relaxed">
                ...
                <div className="premium-card p-6 bg-black/40 backdrop-blur-md hover:border-brand-purple/35 transition-all">
                  <div className="flex gap-4">
                    <span className="flex-shrink-0 w-8 h-8 rounded-lg bg-brand-purple/10 flex items-center justify-center text-brand-purple text-xs font-bold">02</span>
                    <div className="space-y-1">
                      <h4 className="font-bold text-white text-sm">Automated Operations Workload</h4>
                      <p className="text-text-muted text-xs leading-relaxed">
      ...
      {/* Section 5: The Aesthetics (Awards & Design) */}
      <section className="py-28 max-w-6xl mx-auto px-6">
        <ScrollReveal>
          <div className="space-y-12">
            ...
            <div className="max-w-3xl space-y-6">
              ...
              <p className="text-text-light text-base sm:text-lg font-light leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Gallery Item 1 */}
              <div className="group relative premium-card overflow-hidden hover:border-brand-orange/30 transition-all duration-300">
                ...
                <div className="p-6 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[10px] text-text-muted font-bold">200+ Competitors</span>
                  </div>
                  <h3 className="text-base font-bold text-white">NIT Silchar UI/UX Hackathon</h3>
                  <p className="text-text-muted text-xs leading-relaxed">
              ...
              {/* Gallery Item 2 */}
              <div className="group relative premium-card overflow-hidden hover:border-brand-blue/30 transition-all duration-300">
                <div className="aspect-[16/10] overflow-hidden bg-black/50 relative">
                  <img 
                ...
                <div className="p-6 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[10px] text-text-muted font-bold">National Stage</span>
                  </div>
                  <h3 className="text-base font-bold text-white">IIT Guwahati Design Hackathon</h3>
                  <p className="text-text-muted text-xs leading-relaxed">
      ...
      {/* Section 6: The Footer (Call to Action) */}
      <footer className="py-24 bg-black/80 border-t border-white/5 relative overflow-hidden">
        {/* Glow behind contact */}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-12">
          <ScrollReveal>
            <div className="space-y-4">
              <h2 className="text-4xl sm:text-6xl font-black text-white tracking-tight leading-none">
                ...
                <br />
                <span className="bg-gradient-to-r from-brand-orange via-pink-500 to-brand-blue bg-clip-text text-transparent">extraordinary.</span>
              </h2>
          ...
          <ScrollReveal>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-2xl mx-auto flex-wrap">
              ...
              <a 
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 text-xs font-bold text-white bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/10 px-6 py-3.5 rounded-xl transition-all cursor-pointer"
              >
              ...
              <a 
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 text-xs font-bold text-[#0b0c0e] bg-white hover:bg-white/95 px-6 py-3.5 rounded-xl transition-all cursor-pointer shadow-lg shadow-white/5"
              >
          ...
          {/* Back to App Link */}
          <ScrollReveal>
            <div className="pt-8 border-t border-white/5 flex justify-center items-center text-xs text-text-muted/60 gap-4">
              <div className="flex gap-4">
                <Link to="/lobby" className="hover:text-white transition-colors">Workspace Lobby</Link>
                <span>&bull;</span>
                <a href="#top" onClick={(e) => { e.preventDefault(); window.scrollTo({top: 0, behavior: 'smooth'}); }} className="hover:text-white transition-colors">Back to Top</a>
              </div>
            </div>
          </ScrollReveal>
        </div>
